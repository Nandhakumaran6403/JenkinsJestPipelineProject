...
<div class="font-sans text-[#fff]">
      <div class="grid lg:grid-cols-2 items-center gap-y-6 bg-blue-500">
        <div class="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
          <h2 class="lg:text-5xl text-3xl font-bold mb-4 lg:!leading-[56px]">Elevate our nation with Donation</h2>
          ...
          <a href="/login"><button type='button'
            class="bg-transparent hover:bg-blue-600 border-2 border-white mt-10 transition-all text-white font-bold text-sm rounded-md px-6 py-2.5">Get Started</button></a>
        </div>
      ...
      <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-8 px-4 my-12">
        <div class="bg-gray-100 p-6 rounded-md">
          ...
          <p class="text-sm text-[#333]">Tailor your donation to suit your needs.</p>
        ...
        <div class="bg-gray-100 p-6 rounded-md">
          ...
          <p class="text-sm text-[#333]">Experience of Donators</p>
          <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm mt-2 hover:underline">Learn more</a>
        </div>
        <div class="bg-gray-100 p-6 rounded-md">
