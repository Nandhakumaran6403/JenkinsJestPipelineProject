...
function Hero() {
    ...
    const navigation = [
        ...
        { title: "FundRaising", path: "javascript:void(0)" },
        { title: "Collaboration", path: "javascript:void(0)" },
        { title: "Donation", path: "javascript:void(0)" }
    ]
            ...
            <header>
                ...
                <nav className={`pb-5 md:text-sm ${state ? "absolute z-20 top-0 inset-x-0 bg-gray-800 rounded-xl mx-2 mt-2 md:mx-0 md:mt-0 md:relative md:bg-transparent" : ""}`}>
                    <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
                            ...
                            <ul className="flex-1 justify-end items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                                {
                                    navigation.map((item, idx) => {
                                        return (
                                            <li key={idx} className="text-dark-300 hover:text-dark-400">
                        ...
                        <a href="/login" className="block text-dark-300 hover:text-dark-400" >
            ...
            <section className="relative">
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                    <div className="space-y-5 max-w-4xl mx-auto text-center">
                        <img src="https://www.givengain.com/res-bs4/img/charities-signup-header.svg" alt="" />
                        <h2 className="text-4xl text-black font-extrabold mx-auto md:text-5xl" role="heading">
